...
Oh My Herdr now installs and updates versioned SSH execution workers automatically when a connection starts. Compatible workers with live runtimes stay active until they are unused. After a coordinator restart, restored remote panes reconnect their saved SSH connection and re-adopt the live worker runtime.
