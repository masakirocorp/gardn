...
pub struct AgentSoundOverrides {
    ...
    pub mastracode: AgentSoundSetting,
...
impl AgentSoundOverrides {
    pub fn for_agent(&self, agent: Option<Agent>) -> AgentSoundSetting {
        match agent {
            ...
            Some(Agent::Mastracode) => self.mastracode,
...
impl Default for AgentSoundOverrides {
    fn default() -> Self {
        Self {
            ...
            mastracode: AgentSoundSetting::Default,
...
"#;
        ...
        assert_eq!(config.ui.sound.agents.kilo, AgentSoundSetting::Off);
        assert_eq!(config.ui.sound.agents.maki, AgentSoundSetting::Off);
        assert_eq!(
            config.ui.sound.agents.for_agent(Some(Agent::Maki)),
            AgentSoundSetting::Off
        );
        assert_eq!(
            config.ui.sound.agents.for_agent(Some(Agent::Kilo)),
            AgentSoundSetting::Off
        );
