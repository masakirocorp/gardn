...
pub fn generated_schema() -> serde_json::Value {
    gardn_local_api::generated_schema(
...
pub fn toast_position_to_config(position: ToastPosition) -> crate::config::ToastGardnPosition {
    match position {
        ToastPosition::TopLeft => crate::config::ToastGardnPosition::TopLeft,
        ToastPosition::TopRight => crate::config::ToastGardnPosition::TopRight,
        ToastPosition::BottomLeft => crate::config::ToastGardnPosition::BottomLeft,
        ToastPosition::BottomRight => crate::config::ToastGardnPosition::BottomRight,
    }
}
