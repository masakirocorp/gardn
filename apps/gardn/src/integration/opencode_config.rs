...
mod tests {
    ...
    fn add_and_remove_tui_plugin_preserves_jsonc_config() {
        ...
        add_tui_plugin(&dir, "./gardn-tui-session.js").unwrap();
        add_tui_plugin(&dir, "./gardn-tui-session.js").unwrap();
        ...
        assert_eq!(
            ...
            json!([
                ...
                "./gardn-tui-session.js"
            ])
        );

        assert!(remove_tui_plugin(&dir, "./gardn-tui-session.js").unwrap());
    ...
    fn managed_jsonc_leaves_opencode_migration_target_absent() {
        ...
        let config_path = add_tui_plugin(&dir, "./gardn-tui-session.js").unwrap();
        ...
        assert_eq!(
            ...
            json!({ "plugin": ["./gardn-tui-session.js"] })
        );
    ...
    fn configured_tui_plugin_accepts_option_tuple() {
        ...
        fs::write(
            ...
            r#"{"plugin":[["./gardn-tui-session.js",{"enabled":true}]]}"#,
        )
        .unwrap();

        assert!(tui_plugin_is_configured(&dir, "./gardn-tui-session.js"));
        assert!(remove_tui_plugin(&dir, "./gardn-tui-session.js").unwrap());
