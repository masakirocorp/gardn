...
fn windows_input_trace_enabled() -> bool {
    std::env::var_os("GARDN_WINDOWS_INPUT_TRACE").is_some()
}
...
mod tests {
    ...
    fn vti_win32_input_mode_bracketed_paste_key_records_emit_single_paste() {
        ...
        assert_eq!(
            translate(records),
            vec![crate::protocol::ClientInputEvent::Paste(
                "About\ragent multiplexer that lives in your terminal.".into(),
            )]
        );
    }
    ...
    fn vti_win32_input_mode_decoded_paste_handles_shift_repeats_and_releases() {
        ...
        assert_eq!(
            translate(records),
            vec![crate::protocol::ClientInputEvent::Paste("AA".into())]
        );
    }
    ...
    fn vti_win32_input_mode_decoded_paste_flag_clears_after_raw_completion() {
        ...
        assert_eq!(
            translate(records),
            vec![
                crate::protocol::ClientInputEvent::Paste("one".into()),
                crate::protocol::ClientInputEvent::Paste("x\x1b[65;30;97;1;0;1_y".into(),),
            ]
        );
    }
    ...
    #[test]
    fn vti_repeated_virtual_key_records_preserve_grouped_repeat_count() {
        assert_eq!(
    ...
    fn vti_win32_input_mode_sequence_inside_bracketed_paste_stays_payload() {
        ...
        assert_eq!(
            translate(records),
            vec![crate::protocol::ClientInputEvent::Paste(
                "alpha\x1b[13;28;13;1;16;1_bravo".into(),
            )]
        );
    }
    ...
    fn vti_win32_input_mode_raw_sequence_inside_bracketed_paste_stays_payload() {
        ...
        assert_eq!(
            translate(records),
            vec![crate::protocol::ClientInputEvent::Paste(
                "alpha\x1b[0;0;97;1;0;1_bravo".into(),
            )]
        );
    }
    ...
    fn vti_surrogate_pair_paste_preserves_emoji() {
        ...
        assert_eq!(
            events,
            vec![crate::protocol::ClientInputEvent::Paste("🙂".into())]
        );
    }
