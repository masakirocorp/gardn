...
pub const BUILD_CHANNEL: &str = env!("GARDN_BUILD_CHANNEL_EMBEDDED");
pub const BUILD_COHORT: &str = env!("GARDN_BUILD_COHORT_EMBEDDED");
pub const BUILD_TARGET: &str = env!("GARDN_BUILD_TARGET_EMBEDDED");
pub const RELEASE_TAG: &str = env!("GARDN_RELEASE_TAG_EMBEDDED");
