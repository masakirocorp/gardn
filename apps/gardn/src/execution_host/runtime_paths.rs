...
const PRODUCT_COMPONENT: &str = "gardn";
const ROLES_COMPONENT: &str = "roles";
const EXECUTION_WORKER_ROLE: &str = "execution-worker";
const EXECUTION_WORKER_RUNTIME_PREFIX: &str = "gardn-ew";
...
/// authorizes process signals by itself — only discovers Gardn-owned paths.
...
mod tests {
    ...
    fn standalone_coordinator_and_execution_worker_bind_without_interference() {
        ...
        let coordinator_socket = coordinator_root.join("gardn.sock");
    ...
    fn worker_cleanup_cannot_remove_coordinator_or_other_binding_state() {
        ...
        let coordinator_marker = coordinator_root.join("gardn.sock");
