...
use super::{
    input::{
        ...
        ghostty_mouse_event_from_wheel_kind, ghostty_prefers_omh_text_encoding,
    },
    ...
    osc::{
        ...
        AgentOscStateTracker, DefaultColorEvent, DefaultColorOscTracker, DefaultColorQuery,
        Osc52Forwarder, OscColorQueryResponder, OscColorSnapshot,
    },
};
...
impl GhosttyPaneTerminal {
    ...
    pub fn encode_terminal_key(
        ...
        if ghostty_prefers_omh_text_encoding(key) {
...
mod tests {
    ...
    #[test]
    fn ghostty_char_keys_still_use_omh_encoding() {
        let (tx, _rx) = mpsc::channel(4);
        let mut terminal = crate::ghostty::Terminal::new(80, 24, 0).unwrap();
    ...
    fn ghostty_fallback_preserves_function_key_event_kinds() {
        ...
        assert_eq!(
            pane.encode_terminal_key(
                f12.with_kind(crossterm::event::KeyEventKind::Repeat),
                crate::input::KeyboardProtocol::Kitty { flags: 0b0010 },
            ),
            b"\x1b[24;1:2~"
        );
    ...
    fn ghostty_fallback_preserves_printable_and_navigation_event_kinds() {
        ...
        for flags in [0b0010, 0b0111] {
            ...
            assert_eq!(
                pane.encode_terminal_key(plain, crate::input::KeyboardProtocol::Kitty { flags }),
                b"a"
            );
            assert_eq!(
                pane.encode_terminal_key(
