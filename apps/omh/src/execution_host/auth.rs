...
pub(crate) const ASKPASS_ROLE_ENV: &str = "OMH_SSH_ASKPASS_ROLE";
const ASKPASS_SOCKET_ENV: &str = "OMH_SSH_ASKPASS_SOCKET";
const ASKPASS_TOKEN_ENV: &str = "OMH_SSH_ASKPASS_TOKEN";
const ASKPASS_MAGIC: &[u8; 7] = b"OMHASK1";
...
impl AskpassServer {
    pub(crate) fn start(
        ...
        let socket_dir =
            std::env::temp_dir().join(format!("omh-askpass-{}-{scope:016x}", std::process::id()));
