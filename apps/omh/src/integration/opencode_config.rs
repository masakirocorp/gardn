...
mod tests {
    ...
    fn add_and_remove_tui_plugin_preserves_jsonc_config() {
        ...
        add_tui_plugin(&dir, "./omh-tui-session.js").unwrap();
        add_tui_plugin(&dir, "./omh-tui-session.js").unwrap();
        ...
        assert!(remove_tui_plugin(&dir, "./omh-tui-session.js").unwrap());
    ...
    fn managed_jsonc_leaves_opencode_migration_target_absent() {
        ...
        let config_path = add_tui_plugin(&dir, "./omh-tui-session.js").unwrap();
        ...
        assert_eq!(
            ...
            json!({ "plugin": ["./omh-tui-session.js"] })
        );
    ...
    fn configured_tui_plugin_accepts_option_tuple() {
        ...
        fs::write(
            ...
            r#"{"plugin":[["./omh-tui-session.js",{"enabled":true}]]}"#,
        )
        .unwrap();

        assert!(tui_plugin_is_configured(&dir, "./omh-tui-session.js"));
        assert!(remove_tui_plugin(&dir, "./omh-tui-session.js").unwrap());
