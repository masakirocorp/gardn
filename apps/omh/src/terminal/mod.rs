...
pub(crate) use history_read::{
    merge_scrolled_up, snapshot_text, HistoryReadSnapshot, ScreenSnapshot, UpwardMerge,
};
pub use id::TerminalId;
pub use runtime::TerminalRuntime;
pub(crate) use runtime_registry::TerminalRuntimeRegistry;
pub use state::{
    AgentMetadataReport, EffectivePresentation, EffectiveStateChange, TerminalSemanticSnapshot,
