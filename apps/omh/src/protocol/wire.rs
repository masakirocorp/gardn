...
pub enum ClientMessage {
    ...
    /// Result of the one armed Oh My Herdr-owned direct Kitty transmission.
...
pub enum ServerMessage {
    ...
    /// One validated Oh My Herdr-owned Kitty regular-file RGBA transmission.
    GraphicsFile {
        path: String,
        expected_len: u64,
        image_id: u32,
...
mod tests {
    ...
    fn direct_graphics_messages_roundtrip() {
        ...
        let server = ServerMessage::GraphicsFile {
            path: "/run/user/1000/omh/source/frame".into(),
            expected_len: 4,
            image_id: 42,
            transfer_id: 7,
