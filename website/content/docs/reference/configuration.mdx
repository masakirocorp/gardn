...
Oh My Herdr reads a TOML configuration file. This page describes version 0.2.18 configuration behavior and defaults. The generated template is available with [`omh --default-config`](/docs/reference/cli#global-session-and-remote-options).
