...
Use this how-to when the workspaces and panes should run on another Unix host. A plain SSH shell and an Gardn remote client are different paths:
...
Use the managed connection when an agent running on that Execution Host needs an Gardn integration:
