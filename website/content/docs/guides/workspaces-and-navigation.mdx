...
Each workspace in that group inherits the organization. ghui filters its home repository, pull request, and issue collections to that organization. Explicit repository views remain available.
