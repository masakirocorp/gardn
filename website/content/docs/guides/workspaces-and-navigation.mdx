...
| GitHub  | `ghui`              | `brew install kitlangton/tap/ghui`                       |
...
The curated GitHub launcher uses ghui's repository context and mouse controls. Gardn creates a temporary ghui configuration with the system terminal theme and visible scrollbars. Gardn removes this override after ghui exits and does not modify your global ghui configuration.
