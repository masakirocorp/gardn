...
| GitHub  | `gh dash`           | Install `gh`, then run `gh extension install dlvhdr/gh-dash` |
...
To scope GitHub by organization:

1. Right-click the group and select **Settings**.
2. Enter the GitHub login in **GitHub Organization**.
3. Press **Enter** to save it.

Each workspace in that group inherits the organization. Gardn adds open pull request and open issue sections for the organization when it starts gh-dash. Gardn applies this as a one-time override and does not modify your global gh-dash configuration.
