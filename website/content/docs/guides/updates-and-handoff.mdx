...
The [download page](/download) links to the latest verified macOS app. Gardn's update command uses the latest verified GitHub release for the current platform.
