---
title: Install Gardn
description: Download the macOS app, or install Gardn from source or Nix.
---

# Install Gardn

Download the signed macOS app from the [download page](/download). Use a source or Nix installation
when you need a development build or a declarative package.
...
Use the quick start below, or download the signed app from the [download page](/download).
