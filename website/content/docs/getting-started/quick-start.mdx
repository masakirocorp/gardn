---
title: Quick start
description: Launch Oh My Herdr, run an agent, work across panes and tabs, and reconnect to the same session.
---
...
Before you begin, complete the [installation guide](/docs/getting-started/install) and make sure at least one supported agent command is installed and usable in your shell. The agent picker shows profiles that Oh My Herdr can launch; use the first available profile it lists.
