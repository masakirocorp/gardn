...
| Surface                                              | Use it for                                                                                                                  |
| ---------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| [`gardn` CLI](/docs/reference/cli)                   | Shell scripts, one-shot operations, and human debugging. Prefer this when a command already exposes the operation you need. |
| [Agent skill](/docs/guides/plugins-and-integrations) | Teaching an AI coding agent how to operate Gardn from inside a pane.                                                        |
...
```json
{ "id": "example:ping", "result": { "type": "pong", "version": "0.2.19", "protocol": 13 } }
```
