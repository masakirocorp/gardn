...
```json
{
  "id": "ex:send",
  "method": "agent.send",
  "params": { "target": "builder", "text": "summarize the failing tests and propose a fix\n" }
}
```
...
```json
{
  "id": "ex:read",
  "method": "pane.read",
  "params": { "pane_id": "w1943cd2b11a1:p2", "source": "recent", "lines": 40, "format": "text" }
}
```
