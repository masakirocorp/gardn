...
pub(crate) fn load_plugin_manifest(
    ...
    let min_hako_version = validate_min_hako_version(raw.min_hako_version.as_deref())?;
    let description = raw
        .description
...
fn validate_min_hako_version(value: Option<&str>) -> Result<String, (&'static str, String)> {
