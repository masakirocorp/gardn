...
mod tests {
    ...
    fn release_notes_preview_lines_show_update_steps() {
        let palette = Palette::catppuccin();
        let lines = release_notes_preview_lines("0.5.0", "hako update", &palette);
    ...
    fn release_notes_preview_section_expands_for_wrapped_install_command() {
        ...
        let sections =
            release_notes_sections(area, true, "brew update && brew upgrade hako", &palette);
    ...
    fn release_notes_preview_section_keeps_short_install_command_compact() {
        ...
        let sections = release_notes_sections(area, true, "hako update", &palette);
