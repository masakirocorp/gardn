...
| Kiro | install/version check | Kiro does not use OpenRouter BYOK, so CI does not exercise a live Kiro provider path without a dedicated credentialed smoke. |
