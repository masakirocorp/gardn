...
- [0007 — Isolate multi-agent work in task worktrees](0007-isolate-multi-agent-work-in-task-worktrees.md): dedicated task worktrees isolate bigger, risky, parallel, or dirty-shared-checkout work so `../hako` remains safe for integration.
